...
-   Lots up updated data ([NPRB2301_layer_results](https://docs.google.com/spreadsheets/d/1xeHWScrJwWkeN_YV-C6euG_7G4w3u7nHjjew34BoSP0/edit?gid=1357910555#gid=1357910555))
-   We have some decisions to make on the soluble and insoluble protein samples. Are there enough data?
-   For ease of data management, [NPRB2301_layer_results](https://docs.google.com/spreadsheets/d/1xeHWScrJwWkeN_YV-C6euG_7G4w3u7nHjjew34BoSP0/edit?gid=1357910555#gid=1357910555) has been somewhat restructured. The same wide format sheet is available ('combined_layer_results'), but it has a lot of white space. I created separate tabs for each of the data output types to clean up white space.
-   Changed the original specimen summary sheet to [NPRB2301_specimens_available_summary](https://docs.google.com/spreadsheets/d/1J3IKrdptj7eS3VZj_qbxXTXorgktHXnQ_gUv1mVaxwk/edit?gid=1344539499#gid=1344539499). This sheet is a list of all of the animals available for the project.
-   Created a new summary of processed specimens, for a quickie look up cheat sheet [NPRB2301_specimens_processed_summary](https://docs.google.com/spreadsheets/d/1Yr6yGoU-_5JCO69TGdjaRJYhw2AL2YMG6kYeCGMQKyw/edit?gid=1062836159#gid=1062836159). This sheet shows the animals that have had samples processed, what type of analysis and how many per animal.
...
# NOSAMS changed rates in the middle of our project, the values for that period are fixed in the below code now
NOSAMS_start <- 150080 #starting funds at WHOI for 14C samples
nat268 <- 200 #the number of samples that were processed at the $268/sample rate
used268 <- nat268*268
remainbal <- NOSAMS_start - used268
Nstart268 <- nat268
Nstart276 <- floor(remainbal/276) #remaining samples at new rate
Nstart <- Nstart268 + Nstart276
NOSAMS_used <- used268 + 276*(nAMS-19-nat268) #19 from the pilot study
NOSAMS_left <- NOSAMS_start - NOSAMS_used
NOSAMS_sampleft <- floor(NOSAMS_left/276)
```
...
|-----------------|-----------------|-----------------------|-----------------|
| `{r} nCSsent` | 25 | `{r} CSAA_sampleft` | `{r} CSAA_Nstart` |

# Protein Separation

The 14C data are back from NOSAMS. 30 of 36 samples were able to be run. 5 of the lost samples were soluble portions that were too small and the other was lost during processing. We need to determine if we have sufficient data for this analysis!

Soluble and insoluble portion layer results are in the [NPRB2301_layer_results](https://docs.google.com/spreadsheets/d/1xeHWScrJwWkeN_YV-C6euG_7G4w3u7nHjjew34BoSP0/edit?gid=1357910555#gid=1357910555). Samples for this analysis are noted by ams_ids with "I" or "S" at the end.
