...
-   14C results updated ([NPRB2301_layer_results](https://docs.google.com/spreadsheets/d/1xeHWScrJwWkeN_YV-C6euG_7G4w3u7nHjjew34BoSP0/edit?gid=1357910555#gid=1357910555))
-   Stable isotope results updated ([NPRB2301_layer_results](https://docs.google.com/spreadsheets/d/1xeHWScrJwWkeN_YV-C6euG_7G4w3u7nHjjew34BoSP0/edit?gid=1357910555#gid=1357910555))
-   Layer diameters updated ([NPRB2301_layer_results](https://docs.google.com/spreadsheets/d/1xeHWScrJwWkeN_YV-C6euG_7G4w3u7nHjjew34BoSP0/edit?gid=1357910555#gid=1357910555))
-   Spiny dogfish embryo eyes have been delaminated/dried, ready for next steps
-   Spiny dogfish spine reading in progress
-   Samples selected for CSIAA, prepping now (see notes below)
...
all_spec_fig <- ggplot(all_spec, aes(x = l_bin, y = n_sharks, fill = as.factor(rank)))+
  ...
  coord_cartesian(ylim = c(0,roundUpNice(y_max)))+
...
| N 14C sent  | N 14C returned | N 14C samples left per budget |
|-------------|----------------|-------------------------------|
...
|----------------|----------------|-------------------------------|
| `{r} nSIAsent` | `{r} nSIA`     | `{r} SIA_sampleft`            |
...
As per the PI meeting notes, we are sending 5 sequence layers from our two largest animals and the core and outermost layer for 5 of the next largest animals. These eyes are either already delaminated or are in the process and will be shipped soon.
